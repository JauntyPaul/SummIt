        ...
        <div className="lg:mr-12 flex-1">
          ...
          <div className="flex flex-col space-y-5">
            ...
            <div className="flex justify-center">
              <button className="text-gray-800 border border-gray-800 px-20 py-2 rounded-full font-semibold hover:border-gray-500 hover:text-gray-500 " onClick={handleUpload}>UPLOAD FILE</button>
            </div>
